...
IMG ?= $(RETISTRY)/alluxio-operator:$(VERSION)
...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	$(CONTROLLER_GEN) rbac:roleName=manager-role crd:allowDangerousTypes=true,maxDescLen=0 webhook paths="./..." output:crd:artifacts:config=config/crd/bases
